...
class SearchTransfer(nn.Module):
    ...
    #
    #     print(refsr_lv3_unfold.shape, lrsr_lv3_unfold.shape)
    #
    #
    ...
    #
    #     print(S)
    #     print(S.shape,'lrsr_lv3:',refsr_lv3_unfold.shape, 'refsr_lv3:',lrsr_lv3_unfold.shape)
    #     res = S.squeeze().cpu().numpy()
    #     np.save('465152.npy', res)
    #     # return S, T_lv3, T_lv2, T_lv1  # ref_lv3,ref_lv2,ref_lv1
    #
    #     return S, None, None, None  # ref_lv3,ref_lv2,ref_lv1
    #
    ...
    def forward(self, lrsr_lv3, refsr_lv3, ref_lv1, ref_lv2, ref_lv3):
        ...
        return refsr_lv3_unfold, None, None, None  # ref_lv3,ref_lv2,ref_lv1
