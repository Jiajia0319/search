...
parser.add_argument('--model_path', type=str, default='./TTSR.pt',
                    help='The path of model to evaluation')
parser.add_argument('--test', type=str2bool, default=True,
                    help='Test mode')
parser.add_argument('--lr_path', type=str, default='465152.png',
                    help='The path of input lr image when testing')
parser.add_argument('--ref_path', type=str, default='02.png',
